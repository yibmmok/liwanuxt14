	...
	<div class="w-full bg-slate-200 px-4 py-2">
		<div class="w-full flex flex-row justify-start">
			<div class="w-full lg:w-[320px] p-2 border-[0.125rem] border-slate-400">
				<div class="actItem">已加入的雲系統<div class="btnGT" @click="setActive('A01')">&gt;</div></div>
			...
			<div class="hidden lg:block w-[calc(100vw_-_350px)] min-h-[calc(100vh_-_180px)] ml-4 border-[0.125rem] border-slate-300 bg-gray-100">
				<section v-show="step=='A01'">
					...
					<div class="w-full min-h-[380px] bg-white border-2 border-slate-300 overflow-x-hidden overflow-y-auto">
						<div v-for="(object, index) in liwa004" class="w-full py-2 px-8 border-y-2 border-y-dashed border-y-slate-400 flex flex-row cursor-pointer" @click="">
				...
				<section v-show="step=='A03'">
					<div class="w-full lg:w-[768px] h-[78vh] mx-auto my-1 bg-white px-4 py-2">
						<FormKit 
					        form-class="px-4 py-2 bg-gray-200 rounded-2xl w-11/12"
					        type="form"
