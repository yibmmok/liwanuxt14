<script setup lang="ts">
	...
	**********************************************************/	
	...
	const emits = defineEmits(["setDetail", "sendMsg"])
...
<template>
<div class="w-full h-[calc(100vh_-_13rem)] mt-2 border-2 border-gray-400 overflow-x-hidden overflow-y-auto">
